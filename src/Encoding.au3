...
Func _Encoding_GetFileEncoding($sFile, $nReadSize = -1)
	...
	$sRead = FileRead($hFile, 4)
	FileClose($hFile)

	$nByte1 = BinaryMid($sRead, 1, 1)
	$nByte2 = BinaryMid($sRead, 2, 1)
	$nByte3 = BinaryMid($sRead, 3, 1)
...
; Example .......: No
; ===============================================================================================================================
#cs Func _Encoding_UTF8ToANSI_API($sString)
...
Func _Encoding_UTF8ToUnicode_API($sString)
	...
	For $i = 1 To $iStrLen Step 4
		...
		Local $iDecTmp = Dec(StringMid($nHexTmp, 3, 2) & StringMid($nHexTmp, 1, 2))
